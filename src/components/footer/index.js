    ...
    <div className="footer-socials">
      <a href="/" className="footer-socials__item">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M20 3.5C29.113 3.5 36.5 10.887 36.5 20C36.5 29.113 29.113 36.5 20 36.5C10.887 36.5 3.5 29.113 3.5 20C3.5 10.887 10.887 3.5 20 3.5Z" stroke="#778899"/>
      ...
      <a href="/" className="footer-socials__item">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M20 3.5C29.113 3.5 36.5 10.887 36.5 20C36.5 29.113 29.113 36.5 20 36.5C10.887 36.5 3.5 29.113 3.5 20C3.5 10.887 10.887 3.5 20 3.5Z" stroke="#778899"/>
          <path d="M23 12H17C14.239 12 12 14.239 12 17V23C12 25.761 14.239 28 17 28H23C25.761 28 28 25.761 28 23V17C28 14.239 25.761 12 23 12ZM26.5 23C26.5 24.93 24.93 26.5 23 26.5H17C15.07 26.5 13.5 24.93 13.5 23V17C13.5 15.07 15.07 13.5 17 13.5H23C24.93 13.5 26.5 15.07 26.5 17V23Z" fill="#778899"/>
          <path d="M20 16C17.791 16 16 17.791 16 20C16 22.209 17.791 24 20 24C22.209 24 24 22.209 24 20C24 17.791 22.209 16 20 16ZM20 22.5C18.622 22.5 17.5 21.378 17.5 20C17.5 18.621 18.622 17.5 20 17.5C21.378 17.5 22.5 18.621 22.5 20C22.5 21.378 21.378 22.5 20 22.5Z" fill="#778899"/>
          <path d="M24.3 16.233C24.5944 16.233 24.833 15.9944 24.833 15.7C24.833 15.4056 24.5944 15.167 24.3 15.167C24.0056 15.167 23.767 15.4056 23.767 15.7C23.767 15.9944 24.0056 16.233 24.3 16.233Z" fill="#778899"/>
        </svg>
      </a>
    </div>
  );
    ...
    <div className="footer-addresses">
      <div className="footer-addresses__title">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8.95622 1.22628C8.1679 0.437956 7.1168 0 6.00001 0C4.88323 0 3.83213 0.437956 3.02191 1.22628C1.55476 2.69343 1.37958 5.45255 2.62775 7.13869L6.00001 12L9.35038 7.13869C10.6205 5.45255 10.4234 2.69343 8.95622 1.22628ZM6.04381 5.69343C5.18979 5.69343 4.51096 5.0146 4.51096 4.16058C4.51096 3.30657 5.18979 2.62774 6.04381 2.62774C6.89782 2.62774 7.57666 3.30657 7.57666 4.16058C7.57666 5.0146 6.87593 5.69343 6.04381 5.69343Z" fill="#D0101B"/>
        </svg>
      ...
      <a href="mailto:zayavka@copp72.ru" className="footer-addresses__item footer-addresses__item--email">zayavka@copp72.ru</a>
    </div>
  );
  ...
  branch = () => (
    <Link to="/contacts" className="footer__branch">
      <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M7.95622 1.22628C7.1679 0.437956 6.1168 0 5.00001 0C3.88323 0 2.83213 0.437956 2.02191 1.22628C0.554758 2.69343 0.379576 5.45255 1.62775 7.13869L5.00001 12L8.35038 7.13869C9.62045 5.45255 9.42337 2.69343 7.95622 1.22628ZM5.04381 5.69343C4.18979 5.69343 3.51096 5.0146 3.51096 4.16058C3.51096 3.30657 4.18979 2.62774 5.04381 2.62774C5.89782 2.62774 6.57666 3.30657 6.57666 4.16058C6.57666 5.0146 5.87593 5.69343 5.04381 5.69343Z" fill="#778899"/>
      </svg>
